...
/**
 * Clamps `val` to a maximum of -`min` as `val` approaches zero, and a minimum
 * of `min` as `val` approaches zero
 */
...
/**
 * Clamps `val` to a minimum of -`max` as `val` approaches -`max`, and a maximum
 * of `max` as `val` approaches `max`
 */
