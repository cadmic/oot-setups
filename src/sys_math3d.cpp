 ...
 * `overlapSize`
 */
s32 Math3D_SphVsSphOverlapCenter(Sphere16* sphereA, Sphere16* sphereB,
...
/**
 * Checks if `sph` and `cyl` are touching, output the amount of overlap to
 * `overlapSize`
 */
s32 Math3D_SphVsCylOverlapDist(Sphere16* sph, Cylinder16* cyl,
                               f32* overlapSize) {
  f32 centerDist;
 ...
 * to `centerDist`, and the amount of overlap to `overlapSize`
 */
 ...
 * Sets `deadSpace` to the mininum space between the cylinders not occupied by
 * the other.
 */
 ...
 * Sets `deadSpace` to the minimum space between the cylinders not occupied by
 * the other.
 */
s32 Math3D_CylOutsideCylDist(Cylinder16* ca, Cylinder16* cb, f32* deadSpace,
                             f32* xzDist) {
